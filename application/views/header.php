...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg"><b>Aviles Analitica</b></span>
    </a>
        ...
        <ul class="nav navbar-nav">
                ...
                <ul class="menu">
                  <li><!-- start message 
                    <a href="#">
                      <div class="pull-left">
                        <!-- User Image 
                        <img src="<?php echo base_url(); ?>dist/img/a.jpg" class="img-circle" alt="User Image">
                      </div>
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="<?php echo $url; ?>dist/img/a.jpg" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="<?php echo $url; ?>dist/img/a.jpg" class="img-circle" alt="User Image">

                <p>
                  <?php echo $username; ?>
                  <small>Miembro desde 20...</small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
